...
<div class="container" id="page">
	...
	<div id="mainmenu">
		<?php $this->widget('zii.widgets.CMenu',array(
			'items'=>array(
				...
				array('label'=>'PO Approve', 'url'=>array('/po/rilis'), 'visible'=>!Yii::app()->user->isGuest),
				array('label'=>'Penerimaan PO', 'url'=>array('/po/terimapo'), 'visible'=>!Yii::app()->user->isGuest),
	...
	<div id="footer">
		Copyright &copy; <?php echo date('Y'); ?> by IT CTB.<br/>
